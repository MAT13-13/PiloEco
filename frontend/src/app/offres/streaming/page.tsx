...
export default function StreamingOfferPage() {
  ...
  const handleMissionCompleted = async () => {
    ...
    const result = await completeMission({
      user,
      missionId: "streaming",
      title: "Optimiser mes abonnements streaming",
      saving: yearlySaving,
    });
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 rounded-[2rem] border border-green-500/20 bg-white/5 p-8">
          ...
          <PiloAdvice
            ...
            message="Pilo a détecté plusieurs abonnements qui se chevauchent. En regroupant tes plateformes ou en supprimant celles que tu utilises peu, tu peux réduire tes dépenses sans perdre l'essentiel."
          />
