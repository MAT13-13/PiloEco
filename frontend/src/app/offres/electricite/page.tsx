...
export default function ElectriciteOfferPage() {
  ...
  const recommendation = createRecommendation(currentPrice, electriciteOffers);
  ...
  const handleMissionCompleted = async () => {
    ...
    const result = await completeMission({
      user,
      missionId: "electricite",
      title: "Réduire ma facture d'électricité",
      saving,
    });
