      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 rounded-3xl border border-green-500/30 bg-slate-900 p-8">
          ...
          <p className="mt-6 leading-7 text-slate-300">
            Accède à une solution spécialisée pour comparer les diagnostics
            immobiliers et trouver un professionnel adapté à ton projet.
          </p>
          ...
          >
            Découvrir la solution partenaire →
          </a>
